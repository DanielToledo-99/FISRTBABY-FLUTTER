...
import 'package:flutter_application_1/travel_concept_detail_page.dart';
      ...
      child: Container(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: Colors.transparent,
            elevation: 0,
            title: Text('TRIMESTRES DEL EMBARAZO'),
          ),
          body: Column(
            children: [
              Expanded(
...
List<LocationCard> locations = [
  LocationCard(
    title: '',
    imageUrl: 'http://d30s51texww06t.cloudfront.net/primer.jpeg',
  ),
  LocationCard(
    title: '',
    imageUrl: 'http://d30s51texww06t.cloudfront.net/segundo.jpeg',
  ),
  LocationCard(
    title: '',
    imageUrl: 'http://d30s51texww06t.cloudfront.net/tercero.jpeg',
  ),
  LocationCard(
    title: '',
    imageUrl: 'http://d30s51texww06t.cloudfront.net/nacimiento.jpeg',
  ),
];
